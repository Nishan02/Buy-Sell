      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-14">
          <h1 className="text-3xl md:text-4xl font-semibold text-gray-900 mb-4">
            About <span className="text-gray-700">KampusCart</span>
          </h1>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 mb-10">
          <div className="flex items-start gap-4">
            <FaUsers size={20} className="text-gray-500 mt-1" />
            <div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <div className="bg-white border border-gray-200 rounded-xl p-8">
            <FaHandshake size={20} className="text-gray-500 mb-4" />
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-8">
            <FaShieldAlt size={20} className="text-gray-500 mb-4" />
            <h3 className="text-lg font-medium text-gray-900 mb-2">
